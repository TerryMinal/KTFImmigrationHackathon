...
posts = csvToDictModule.csvToDict("posts.csv")
...
<!-- I WANNA WRITE MY OWN BLOG POST -->
<form action="blogPost.py" method="POST">
<input type="submit" value="Write your own post!">
</form>
